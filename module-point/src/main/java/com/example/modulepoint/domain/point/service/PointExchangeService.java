...
public class PointExchangeService {
	...
	@Transactional
	public PointExchangeResponse exchangePoint(Long pointHistoryId) {
		...
		Long memberId = pointHistory.getMemberId();
	...
	public PointHistoryResponse getExchangeRequestPointHistory(Long pointHistoryId) {
		PointHistory pointHistory = getPointHistory(pointHistoryId);
		return PointHistoryResponse.of(pointHistory);
	}

	@Transactional(readOnly = true)
	public PagedModel<PointHistoryResponse> getExchangeRequestPointHistories(int page) {
